...
```sh
pip install git+https://github.com/dojeda/quetzal-openapi-client.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/dojeda/quetzal-openapi-client.git`)
